...
void main( void )
{
	...
	if(gl_FragColor.r<0.2&&gl_FragColor.g<0.2&&gl_FragColor.b<0.2) gl_FragColor.a=0.0;
	if(gl_FragColor.g<0.2) gl_FragColor.g=1.0;
	if(gl_FragColor.b>0.2) gl_FragColor.b=0.2;
	gl_FragColor.r=1.0;
