...
void main( void )
{
	...
	if(gl_FragColor.r>0.5 && gl_FragColor.r<0.9)
	{
		gl_FragColor.r+=0.2;
	}
	else if(gl_FragColor.r>0.1 && gl_FragColor.r<0.5)
	{
		gl_FragColor.r-=0.1;
	}

	if(gl_FragColor.g>0.5 && gl_FragColor.g<0.9)
	{
		gl_FragColor.g+=0.2;
	}
	else if(gl_FragColor.g>0.1 && gl_FragColor.g<0.5)
	{
		gl_FragColor.g-=0.1;
	}

	if(gl_FragColor.b>0.5 && gl_FragColor.b<0.9)
	{
		gl_FragColor.b+=0.2;
	}
	else if(gl_FragColor.b>0.1 && gl_FragColor.b<0.5)
	{
		gl_FragColor.b-=0.05;
	}
