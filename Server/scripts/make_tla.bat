...
@: Mapper
@del ".\\fo_mapper.dll"
cl.exe /nologo /MT /W3 /O2 /Gd /D "__MAPPER" /Fo".\\fo_mapper.obj" /Fd".\\" /FD /c ".\\fonline_tla.cpp"
link.exe /nologo /dll /incremental:no /machine:I386 ".\\fo_mapper.obj" /out:".\\fo_mapper.dll"
