...
EXPORT int getParam_ArmorBonus( CritterMutual& cr, uint index )
{
    ...
    switch( index )
    {
    case ARMOR_BONUS_DRLASER:
        val = cr.Params[ ARMOR_BONUS_DRLASER ];
        break;
    case ARMOR_BONUS_DRFIRE:
        val = cr.Params[ ARMOR_BONUS_DRFIRE ];
        break;
    case ARMOR_BONUS_DRPLASMA:
        val = cr.Params[ ARMOR_BONUS_DRPLASMA ];
        break;
    case ARMOR_BONUS_DRELECTR:
        val = cr.Params[ ARMOR_BONUS_DRELECTR ];
        break;
    case ARMOR_BONUS_DREXPLODE:
        val = cr.Params[ ARMOR_BONUS_DREXPLODE ];
        break;
    case ARMOR_BONUS_DTNORMAL:
        val = cr.Params[ ARMOR_BONUS_DTNORMAL ];
        break;
    case ARMOR_BONUS_DTLASER:
        val = cr.Params[ ARMOR_BONUS_DTLASER ];
        break;
    case ARMOR_BONUS_DTFIRE:
        val = cr.Params[ ARMOR_BONUS_DTFIRE ];
        break;
    case ARMOR_BONUS_DTPLASMA:
        val = cr.Params[ ARMOR_BONUS_DTPLASMA ];
        break;
    case ARMOR_BONUS_DTELECTR:
        val = cr.Params[ ARMOR_BONUS_DTELECTR ];
        break;
    case ARMOR_BONUS_AC:
        val = cr.Params[ ARMOR_BONUS_AC ];
        break;
    case ARMOR_BONUS_DTEXPLODE:
        val = cr.Params[ ARMOR_BONUS_DTEXPLODE ];
        break;
    case ARMOR_BONUS_DRRAD:
        val = cr.Params[ ARMOR_BONUS_DRRAD ];
        break;
    case ARMOR_BONUS_CARRYWEIGHT:
        val = cr.Params[ ARMOR_BONUS_CARRYWEIGHT ];
        break;
    case ARMOR_BONUS_FASTERHEALING:
        val = cr.Params[ ARMOR_BONUS_FASTERHEALING ];
        break;
    case ARMOR_BONUS_HARISMA:
        val = cr.Params[ ARMOR_BONUS_HARISMA ];
        break;
    case ARMOR_BONUS_PERCEPTION:
        val = cr.Params[ ARMOR_BONUS_PERCEPTION ];
        break;
    case ARMOR_BONUS_STRENGTH:
        val = cr.Params[ ARMOR_BONUS_STRENGTH ];
        break;
    case ARMOR_BONUS_CRITICAL_RESISTANCE:
        val = cr.Params[ ARMOR_BONUS_CRITICAL_RESISTANCE ];
        break;
    case ARMOR_BONUS_LUCK:
        val = cr.Params[ ARMOR_BONUS_LUCK ];
        break;
    case ARMOR_BONUS_ACTION_POINTS:
        val = cr.Params[ ARMOR_BONUS_ACTION_POINTS ];
        break;
    case ARMOR_BONUS_DRNORMAL:
        val = cr.Params[ ARMOR_BONUS_DRNORMAL ];
        break;
    case ARMOR_BONUS_MELEE_DAMAGE:
        val = cr.Params[ ARMOR_BONUS_MELEE_DAMAGE ];
        break;

    default:
        break;
    }
    return CLAMP( val, 0, 60000 );
}
